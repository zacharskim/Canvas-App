...
const FRAME_LIMIT = 12; //instead of drawing 60 times a second we draw every 12 animate requests frames...
const MOVEMENT_SPEED = 5;
//above are jsut constant variables that don't change...

//canvas stuff...
let canvas = document.querySelector("canvas");
let ctx = canvas.getContext("2d");
let keyPresses = {};
//object to track keys ^^

//direction is just a number i gues...
