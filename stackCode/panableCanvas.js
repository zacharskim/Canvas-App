...
//this is a differnt draw function i guess???
...
window.onmousemove = function (e) {
  ...
  if (mouseHeld) {
    if (!selectedBox) {
      //this is where the viewport is adjusted...
      //basically i think that the boxes are being adjusted...
...
//drawing fuction, only thing used in the requestAnimationFrame
function draw() {
  ctx.fillStyle = "gray";
